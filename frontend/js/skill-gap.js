...
const companyMap = {
    ...
    // ── Finance & Banking ──────────────────────────────────
    "goldman sachs":  { track: "data-science",  label: "Goldman Sachs",   emoji: "🏦", location: "New York, NY" },
    "goldman":        { track: "data-science",  label: "Goldman Sachs",   emoji: "🏦", location: "New York, NY" },
    "gs":             { track: "data-science",  label: "Goldman Sachs",   emoji: "🏦", location: "New York, NY" },
    "jp morgan":      { track: "data-science",  label: "JP Morgan",       emoji: "🏦", location: "New York, NY" },
    "jpmorgan":       { track: "data-science",  label: "JP Morgan",       emoji: "🏦", location: "New York, NY" },
    "jpm":            { track: "data-science",  label: "JP Morgan",       emoji: "🏦", location: "New York, NY" },
    "morgan stanley": { track: "data-science",  label: "Morgan Stanley",  emoji: "🏦", location: "New York, NY" },
    "morgan":         { track: "data-science",  label: "Morgan Stanley",  emoji: "🏦", location: "New York, NY" },
    "blackrock":      { track: "data-science",  label: "BlackRock",       emoji: "🪨", location: "New York, NY" },
    "citadel":        { track: "machine-learning", label: "Citadel",      emoji: "🏰", location: "Chicago, IL" },
    "two sigma":      { track: "machine-learning", label: "Two Sigma",    emoji: "📐", location: "New York, NY" },
    "twosigma":       { track: "machine-learning", label: "Two Sigma",    emoji: "📐", location: "New York, NY" },
    "jane street":    { track: "machine-learning", label: "Jane Street",  emoji: "📊", location: "New York, NY" },
    "janestreet":     { track: "machine-learning", label: "Jane Street",  emoji: "📊", location: "New York, NY" },
    "bloomberg":      { track: "backend",       label: "Bloomberg",       emoji: "📰", location: "New York, NY" },
    "visa":           { track: "backend",       label: "Visa",            emoji: "💳", location: "Foster City, CA" },
    "mastercard":     { track: "backend",       label: "Mastercard",      emoji: "💳", location: "Purchase, NY" },
    "american express":{ track: "data-science", label: "American Express",emoji: "💳", location: "New York, NY" },
    "amex":           { track: "data-science",  label: "American Express",emoji: "💳", location: "New York, NY" },
    "paypal":         { track: "backend",       label: "PayPal",          emoji: "💸", location: "San Jose, CA" },
    "fidelity":       { track: "data-science",  label: "Fidelity",        emoji: "📈", location: "Boston, MA" },
    "citi":           { track: "data-science",  label: "Citibank",        emoji: "🏦", location: "New York, NY" },
    "citibank":       { track: "data-science",  label: "Citibank",        emoji: "🏦", location: "New York, NY" },
    "wells fargo":    { track: "data-science",  label: "Wells Fargo",     emoji: "🏦", location: "San Francisco, CA" },
    "barclays":       { track: "data-science",  label: "Barclays",        emoji: "🏦", location: "London, UK" },
    "deutsche bank":  { track: "data-science",  label: "Deutsche Bank",   emoji: "🏦", location: "Frankfurt, Germany" },
    "hsbc":           { track: "data-science",  label: "HSBC",            emoji: "🏦", location: "London, UK" },
    "ubs":            { track: "data-science",  label: "UBS",             emoji: "🏦", location: "Zurich, Switzerland" },
    "credit suisse":  { track: "data-science",  label: "Credit Suisse",   emoji: "🏦", location: "Zurich, Switzerland" },

    // ── Consulting ─────────────────────────────────────────
    "mckinsey":       { track: "data-science",  label: "McKinsey",        emoji: "📋", location: "New York, NY" },
    "bcg":            { track: "data-science",  label: "BCG",             emoji: "📋", location: "Boston, MA" },
    "boston consulting": { track: "data-science", label: "BCG",           emoji: "📋", location: "Boston, MA" },
    "bain":           { track: "data-science",  label: "Bain & Company",  emoji: "📋", location: "Boston, MA" },
    "ey":             { track: "data-science",  label: "EY",              emoji: "📊", location: "London, UK" },
    "ernst young":    { track: "data-science",  label: "EY",              emoji: "📊", location: "London, UK" },
    "capgemini":      { track: "cloud",         label: "Capgemini",       emoji: "🔷", location: "Paris, France" },
    "booz allen":     { track: "cybersecurity", label: "Booz Allen Hamilton", emoji: "🔐", location: "McLean, VA" },

    // ── E-commerce & Logistics ─────────────────────────────
    "walmart":        { track: "data-science",  label: "Walmart",         emoji: "🛒", location: "Bentonville, AR" },
    "target":         { track: "data-science",  label: "Target",          emoji: "🎯", location: "Minneapolis, MN" },
    "fedex":          { track: "backend",       label: "FedEx",           emoji: "📦", location: "Memphis, TN" },
    "dhl":            { track: "backend",       label: "DHL",             emoji: "📦", location: "Bonn, Germany" },
    "jio":            { track: "app-development",label: "Jio",            emoji: "📡", location: "Mumbai, India" },
    "reliance":       { track: "data-science",  label: "Reliance",        emoji: "🏢", location: "Mumbai, India" },
    "tata":           { track: "cloud",         label: "Tata Group",      emoji: "🏢", location: "Mumbai, India" },
    "mahindra":       { track: "cloud",         label: "Mahindra Tech",   emoji: "🏢", location: "Mumbai, India" },
    "myntra":         { track: "app-development",label: "Myntra",         emoji: "👗", location: "Bengaluru, India" },
    "amazon india":   { track: "cloud",         label: "Amazon India",    emoji: "📦", location: "Bengaluru, India" },

    // ── Gaming & Media ─────────────────────────────────────
    "epic games":     { track: "app-development",label: "Epic Games",     emoji: "🎮", location: "Cary, NC" },
    "epicgames":      { track: "app-development",label: "Epic Games",     emoji: "🎮", location: "Cary, NC" },
    "riot games":     { track: "backend",        label: "Riot Games",     emoji: "🎮", location: "Los Angeles, CA" },
    "riotgames":      { track: "backend",        label: "Riot Games",     emoji: "🎮", location: "Los Angeles, CA" },
    "unity":          { track: "app-development",label: "Unity",          emoji: "🎮", location: "San Francisco, CA" },
    "ea":             { track: "app-development",label: "EA Sports",      emoji: "🎮", location: "Redwood City, CA" },
    "electronic arts":{ track: "app-development",label: "EA Sports",      emoji: "🎮", location: "Redwood City, CA" },
    "activision":     { track: "app-development",label: "Activision",     emoji: "🎮", location: "Santa Monica, CA" },
    "disney":         { track: "data-science",   label: "Disney",         emoji: "🏰", location: "Burbank, CA" },
    "youtube":        { track: "data-science",   label: "YouTube",        emoji: "▶️", location: "San Bruno, CA" },
    "tiktok":         { track: "machine-learning",label: "TikTok",        emoji: "🎵", location: "Los Angeles, CA" },
    "bytedance":      { track: "machine-learning",label: "ByteDance",     emoji: "🎵", location: "Beijing, China" },

    // ── Semiconductors & Hardware ───────────────────────────
    "amd":            { track: "machine-learning",label: "AMD",           emoji: "🔴", location: "Santa Clara, CA" },
    "arm":            { track: "machine-learning",label: "ARM",           emoji: "🔷", location: "Cambridge, UK" },
    "broadcom":       { track: "cloud",           label: "Broadcom",      emoji: "🔵", location: "San Jose, CA" },
    "cisco":          { track: "cybersecurity",   label: "Cisco",         emoji: "🌐", location: "San Jose, CA" },
    "dell":           { track: "cloud",           label: "Dell",          emoji: "💻", location: "Round Rock, TX" },
    "hp":             { track: "cloud",           label: "HP",            emoji: "💻", location: "Palo Alto, CA" },
    "samsung":        { track: "app-development", label: "Samsung",       emoji: "📱", location: "Seoul, South Korea" },
    "sony":           { track: "app-development", label: "Sony",          emoji: "🎮", location: "Tokyo, Japan" },

    // ── AI / Research Labs ─────────────────────────────────
    "openai":         { track: "machine-learning",label: "OpenAI",        emoji: "🤖", location: "San Francisco, CA" },
    "anthropic":      { track: "machine-learning",label: "Anthropic",     emoji: "🤖", location: "San Francisco, CA" },
    "deepmind":       { track: "machine-learning",label: "DeepMind",      emoji: "🧠", location: "London, UK" },
    "hugging face":   { track: "machine-learning",label: "Hugging Face",  emoji: "🤗", location: "New York, NY" },
    "huggingface":    { track: "machine-learning",label: "Hugging Face",  emoji: "🤗", location: "New York, NY" },
    "cohere":         { track: "machine-learning",label: "Cohere",        emoji: "🤖", location: "Toronto, Canada" },
    "mistral":        { track: "machine-learning",label: "Mistral AI",    emoji: "🤖", location: "Paris, France" },
    "groq":           { track: "machine-learning",label: "Groq",          emoji: "⚡", location: "Mountain View, CA" },
};
